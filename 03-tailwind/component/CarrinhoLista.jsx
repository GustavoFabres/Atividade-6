    ...
    return(
      ...
      {Carregando && <h1 className="animacaoGirar colorPrincipal2Texto"><VscSync /></h1>}
        {!Carregando && <ul className="listaGrid4-1">
            {Produtos[0][6] && <li className={`tamanho100px  bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[0][1]}</strong> 
            <p>Preço: {Produtos[0][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(1)}>Remover</button>
            </li >}
                        {Produtos[1][6] && <li className={`tamanho100px bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[1][1]}</strong> 
            <p>Preço: {Produtos[1][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(2)}>Remover</button>
            </li>}
                        {Produtos[2][6] && <li className={`tamanho100px bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[2][1]}</strong> 
            <p>Preço: {Produtos[2][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(3)}>Remover</button>
            </li>}
                        {Produtos[3][6] && <li className={`tamanho100px bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[3][1]}</strong> 
            <p>Preço: {Produtos[3][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(4)}>Remover</button>
            </li>}
                        {Produtos[4][6] && <li className={`tamanho100px bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[4][1]}</strong> 
            <p>Preço: {Produtos[4][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(5)}>Remover</button>
            </li>}
                        {Produtos[5][6] && <li className={`tamanho100px bordaCircular colorPrincipal sombra margin20px pading10 ${Altera}`}>
                <strong>{Produtos[5][1]}</strong> 
            <p>Preço: {Produtos[5][2]}</p>
            <button className="pading10 borderNone bordaCircular pointerCursor textoDecoracaoButtonNone colorButtonRemover" onClick={() => Remover(6)}>Remover</button>
            </li>}
        </ul>}
      </>
    )
